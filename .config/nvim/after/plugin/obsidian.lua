...
obs.setup({
  ...
  -- WARNING: problem with this approach, if ObsidianTomorrow used and the date is starting a new month
  -- It will keep it within the current date of file note
  daily_notes = {
    -- Optional, if you keep daily notes in a separate directory.
    folder = [[Daily Notes/]] .. os.date("%Y/%B"),
    -- Optional, if you want to change the date format for the ID of daily notes.
    date_format = "%d-%m-%Y %A",
    -- Optional, if you want to change the date format of the default alias of daily notes.
    alias_format = "%B %-d, %Y",
    -- Optional, if you want to automatically insert a template from your template directory like 'daily.md'
    template = "basic-daily-journaling.md.md"
  },
